    ...
    <nav class="universal-nav" role="navigation">
        ...
        <img src="logo.png" alt="SalonSpear Logo" style="height: 60px; width: auto;">
            ...
            <ul class="universal-nav-menu" id="nav-menu">
                <li class="universal-nav-item"><a href="home.php" class="universal-nav-link">Home</a></li>
                <li class="universal-nav-item"><a href="product.php" class="universal-nav-link">Products</a></li>
                <li class="universal-nav-item"><a href="my_booking.php" class="universal-nav-link">My Appointments</a></li>
                <!-- <li class="universal-nav-item"><a href="cancel_service.php" class="universal-nav-link">Cancel Appointments</a></li> -->
                <li class="universal-nav-item"><a href="#footer" class="universal-nav-link" id="contact-btn">Contact Us</a></li>
            ...
            <div class="universal-footer-row">
                <div class="universal-footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="cust_view_booking.php">View Bookings Availability</a></li>
